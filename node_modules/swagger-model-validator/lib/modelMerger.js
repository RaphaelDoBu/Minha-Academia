...
Merger.prototype.dereferenceModel = function(target, swaggerModel, swaggerModels) {
    var model = getReferencedModel(swaggerModel, swaggerModels);
    model = getDiscriminatedModel(target, model, swaggerModels);
    return model;
};
...
function getReferencedModel(model, models) {
